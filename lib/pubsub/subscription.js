...
/**
 * Modify the push configuration for a specific message. This method is used to
 * swtich between the push and pull delivery methods.
 *
 * @param {object} options - The configuration object.
 * @param {string} options.pushEndpoint - Url with ssl support for receiving push messages.
 * @param {Function=} callback - The callback function.
 *
 * @example
 * var options = {
 ...
 * };
 *
 * subscription.modifyPushConfig(options, function(err, apiResponse) {});
 */
Subscription.prototype.setPushConfig = function(options, callback) {
  var body = {
  ...
  var path = this.name + ':modifyPushConfig';
